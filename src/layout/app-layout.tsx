...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Pet', path: '/pets', entity: 'pet', service: AccessServiceEnum.PROJECT, icon: FiFeather },
  { name: 'Pet Care', path: '/pet-cares', entity: 'pet_care', service: AccessServiceEnum.PROJECT, icon: FiHome },
