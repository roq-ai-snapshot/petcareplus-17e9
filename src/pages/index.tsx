...
function HomePage() {
  return (
    <>
      <Head>
        <title>PetCarePlus</title>

        <meta
          name="description"
          content="Empower Your Pet's Well-Being with PetCarePlus: Comprehensive Pet Care Management for Vaccinations, Appointments, Grooming, Medication, and Unconditional Love."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              Empower Your Pet's Well-Being with PetCarePlus: Comprehensive Pet Care Management for Vaccinations,
              Appointments, Grooming, Medication, and Unconditional Love.
            </Text>
            <Text>Founder</Text>
